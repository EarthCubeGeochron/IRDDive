...
publications <- fromJSON(txt = 'input/IRD/bibjson', flatten = TRUE)

if(!file.exists('input/IRD/sentences_nlp352.tsv')){
  data(nlp)
  full_nlp <- nlp
  rm(nlp)
  ...
  full_nlp <- readr::read_tsv('input/IRD/sentences_nlp352.tsv',
                         trim_ws = TRUE,
...
#                  user = db_con$user,
#                  password = db_con$user,
#                  host = db_con$host,
#                  port = db_con$port,
#                  dbname = db_con$database)
#
# load_dd(con,
#         bib = 'input/IRD/bibjson',
#         sent = 'input/IRD/sentences_nlp352.tsv')

publications <- jsonlite::fromJSON('input/bibjson')
