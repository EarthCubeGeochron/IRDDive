...
short_table %>% datatable(escape = FALSE, rownames = TRUE)
```
...
```{r, echo = OFF, result = 'hide', message=FALSE}
tests <- readr::read_delim('data/coord_test.txt', comment = '#', col_names = FALSE, delim = '\t')
```
...
tests$dms <- ifelse(stringr::str_detect(tests, dms_regex))
