...
* GeoDeepDive is digital library that allows automated, secure acquisition and management of documents, supporting large-scale text and data mining of published, peer-reviewed journal articles.
...
GeoDeepDive contains > 9 million records at present.  These documents contain over XXX sentences and XXXX unique words.  The process of working with these records is itterative, since the time required to process and manupilate data is time consuming.
...
To understand the process we will undertake an example workflow to extract space and time coordinates for evidence of icce-rafted debris (IRD) in the Pleistocene. Many publications document the existence of IRD at the level of individualmarine drilling sites, but assembling this information across publications into large-scale mapped syntheses is a non-trivial task that has traditionally taken years of painstaking literature compilation. Building a database of IRD deposits and their spatial distributtion from the literature will help our community better understand and characterize Northern and Southern Hemisphere ice sheets over the last 5.3 million years, ideally leading to a better understanding of glacial-interglacial cycles.  
